    ...
    return (
        <Fragment>
            ...
            <TodoList>
                ...
                {!loading && (!searchedTodos.length) && <p className='state-text'>Crea tu primera tarea!</p>}

                {Array.isArray(searchedTodos) && searchedTodos.map(({ title, taskName, isCompleted, date }) => (
                    <TodoItem 
